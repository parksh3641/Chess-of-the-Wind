...
//    public TestRouletteContent rouletteContent;
...
//    public TestRouletteContent[] rouletteContents;

//    List<TestRouletteContent> rouletteContentList = new List<TestRouletteContent>();
//    List<TestRouletteContent> splitHorizontalContentList = new List<TestRouletteContent>();
//    List<TestRouletteContent> splitVertialContentList = new List<TestRouletteContent>();
//    List<TestRouletteContent> streetContentList = new List<TestRouletteContent>();
//    List<TestRouletteContent> etcContentList = new List<TestRouletteContent>();

//    List<TestRouletteContent> allContentList = new List<TestRouletteContent>();

//    List<TestMoneyContent> moneyContentList = new List<TestMoneyContent>();
...
//        for (int i = 0; i < 37; i ++)
//        {
//            TestRouletteContent content = Instantiate(rouletteContent);
...
//            content.transform.localPosition = Vector3.zero;
//            content.transform.localScale = Vector3.one;
//            content.Initialize(this, RouletteType.SplitBet_Horizontal, i);
...
//            if(i % 3 == 0) //Street
//            {
//                content.Initialize(this, RouletteType.SplitBet_Vertical, street);
//                street++;
//                streetContentList.Add(content);
//            }
//            else
//            {
//                content.Initialize(this, RouletteType.SplitBet_Horizontal, split);
//                split++;
...
//                    break;
//                case 1:
//                    content.Initialize(this, RouletteType.SplitBet_Vertical, 0);
//                    break;
//                case 2:
//                    content.Initialize(this, RouletteType.SplitBet_Vertical, 1);
//                    break;
//                case 3:
...
//        for (int i = 0; i < 9; i ++)
//        {
//            TestMoneyContent content = Instantiate(moneyContent);
...
//        ChangeBettingMoney(TestMoneyType.One);
...
//    public void ChangeBettingMoney(TestMoneyType type)
//    {
