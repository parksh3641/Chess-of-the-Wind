...
public class ResetInfo
{
    ...
    public int dailyNormalBox_1 = 30;
    public int dailyNormalBox_10 = 3;
    public int dailyEpicBox_1 = 30;
    public int dailyEpicBox_10 = 3;
...
public class ResetManager : MonoBehaviour
{
    ...
    void ResetValue()
    {
        ...
        if (isNextDay)
        {
            ...
            playerDataBase.ResetInfo.dailyNormalBox_1 = 30;
            playerDataBase.ResetInfo.dailyNormalBox_10 = 3;
            playerDataBase.ResetInfo.dailyEpicBox_1 = 30;
            playerDataBase.ResetInfo.dailyEpicBox_10 = 3;
